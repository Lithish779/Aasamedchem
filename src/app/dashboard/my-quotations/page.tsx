...
type Quotation = {
  ...
  created_at: string; items: QuotationItem[];
};
...
export default function MyQuotationsPage() {
  ...
  return (
    <div className="animate-fade-in">
      <div className="mb-6">
        <h1 className="font-display text-2xl font-semibold text-ink-100">My Quotations</h1>
        <p className="text-sm mt-1" style={{ color: "var(--color-text-muted)" }}>View the status of your submitted quotation requests</p>
      </div>
      ...
      {!loading && quotations.length === 0 && (
        <div className="card py-16 text-center">
          <p className="text-sm" style={{ color: "var(--color-text-muted)" }}>You have not submitted any quotations yet.</p>
        </div>
      )}
